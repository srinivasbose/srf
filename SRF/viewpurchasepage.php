...
$purchase_rows=mysql_query($sql1);
...
<title>View Purchase Details Page</title>
...
<script type="text/javascript">
  ...
  var docprint=window.open("","",disp_setting); 
   ...
   docprint.document.write('<html><head><title>Purchase Details</title>'); 
   docprint.document.write('</head><body onLoad="self.print()">');          
   docprint.document.write('<h4>Purchase Information for <?php echo ($currentmonthname." ".$currentyear);?> as on <?php echo $currentdate?></h4><center>'); 
...
<div class="layout">
	<div class="main">
	  ...
	  <div class="content" width=100%>
            ...
            The Purchase details for every month can be viewed in this page.
            </div>
          <div class="details">
		  <form action="viewpurchasepage.php" method="post">
		  <tr>
        	<p>
		...
		<tr>
				<p>
			Purchase Information for <?php echo ($currentmonthname." ".$currentyear);?> as on <?php echo $currentdate?>
			</p>
			</tr>
...
<?php
while($purchasedetail=mysql_fetch_array($purchase_rows))
{
$retrieveddate=$purchasedetail['DATE'];
...
<td>
<?php
echo $purchasedetail['NAME'];
?>
</td>
<td>
<?php
echo $purchasedetail['ADDRESS'];
?>
</td>

<td>
<?php
echo $purchasedetail['ITEM'];
?>
</td>
<td>
<?php
echo $purchasedetail['BRAND'];
?>
</td>
<td>
<?php
echo $purchasedetail['QUANTITY'];
?>
</td>
